                ...
                <ThemedView style={styles.fotoInfo}>
                  ...
                  <TouchableOpacity onPress={() => {
                    if (window.confirm('¿Borrar esta foto?')) {
                      borrarFoto(foto.id);
                      if (fotoActual >= fotosOrdenadas.length - 1) {
                        setFotoActual(Math.max(0, fotosOrdenadas.length - 2));
                      }
                    }
                  }}>
...
const styles = StyleSheet.create({
  ...
  preview: {
    ...
    resizeMode: 'cover', marginBottom: 8,
  },
  input: {
  ...
  botonGuardar: {
    backgroundColor: '#208AEF', padding: 16, borderRadius: 12,
    alignItems: 'center', marginTop: 8,
  },
  botonRepetir: {
    borderWidth: 2, borderColor: '#208AEF', padding: 14,
  ...
  botonPrincipal: {
    backgroundColor: '#208AEF', padding: 24, borderRadius: 16,
    alignItems: 'center', marginBottom: 16, gap: 8,
  },
  botonSecundario: {
    borderWidth: 2, borderColor: '#208AEF', padding: 24,
  ...
  punto: {
    width: 8, height: 8, borderRadius: 4, backgroundColor: '#ccc',
  },
